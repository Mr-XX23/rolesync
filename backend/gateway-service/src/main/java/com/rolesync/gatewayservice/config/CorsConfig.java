package com.rolesync.gatewayservice.config;
...
public class CorsConfig {
    ...
    @Value("${cors.allowed-headers:Authorization,Content-Type,X-Requested-With,Accept,Origin,X-CSRF-TOKEN,X-User-Id,X-Auth-User-Id,X-Tenant-Id,x-tenant-id,x-user-id,x-auth-user-id}")
